  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center p-4 font-sans overflow-hidden">
      ...
      >
        ...
        <h1 className="text-5xl font-black tracking-tighter font-heading uppercase drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)]">GENX CLOUD POS</h1>
        <p className="text-white/80 text-lg font-medium">Select your role to continue</p>
      </motion.div>

      <div className="relative z-10 w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
        {/* Admin Card */}
        <RoleCard
          title="Administrator"
          icon={Shield}
